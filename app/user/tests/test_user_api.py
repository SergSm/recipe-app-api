...
class PublicUserAPITests(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'smirnovserg.s@gmail.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='smirnovserg.s@gmail.com', password='testpass')
        payload = {'email': 'smirnovserg.s@gmail.com', 'password': 'wrong'}
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'email': 'smirnovserg.s@gmail', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
